...
<div class="panel panel-primary form-group">
  ...
  <input type="hidden">
    ...
    <div class="form-group">
          <div class="form-group"><label>弹幕开关</label></div>
        ...
        <div class="form-group">
          <div class="form-group"><label>防盗链开关</label></div>
          <label class="checkbox-inline">
              <input type="radio" value="on" name="lele[fdhost_on]" <?php $t=$lele['fdhost_on'];  if ($t=="on") { echo "checked";} ?> > 开启防盗链</span></label>
             <label class="checkbox-inline"><input type="radio" value="off" style=" margin-left:20px;" name="lele[fdhost_on]" <?php $t=$lele['fdhost_on'];  if ($t=="off") { echo "checked";} ?> > 关闭防盗链</span></label>
        </div>
        <div class="form-group">
          <label>防盗链域名<small>（填写防盗链域名，用英文逗号隔开，不需要加http|https和端口号）</small></label>
		  <textarea style="max-width:100%;" type="text" name="lele[fdhost]" class="form-control textarea animate-box" rows="1" placeholder="jx.lecurl.cn,lecurl.cn" ><?php echo $lele['fdhost']?></textarea>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <label>KEY<small>此处不要填写KEy！！此处不要填写KEy！！此处不要填写KEy！！请看说明文档</small></label>
		    <textarea style="max-width:100%;" type="text" name="lele[key]" class="form-control textarea animate-box" rows="1" placeholder="key" ><?php echo $lele['key']?></textarea>
        </div>
        <div class="form-group">
